...
if KeyInput.Finish and KeyInput:verifyHWID() and game.PlaceId == 13127800756 then
  ...
  local NPCE = Game.Zones:FindFirstChild("AquaEvent").Interactables.ArmWrestling.NPC:GetChildren()
  ...
  AWSFarm:AddToggle({
    ...
    Callback = function(bool)
      ...
      if bool then
        ...
        if selectedNPCE then
          autoArmWrestle(4, selectedNPC4)
          autoAttack()
        end
        if selectedNPC4 then
          autoArmWrestle("AquaEvent", selectedNPCE)
          autoAttack()
        end
      end
    end
...
--   })
  ...
  AWSTeleport:AddDropdown({
    Name = "Select Zone",
    Default = "None",
    Options = {"BackToSchool", "Futuristic", "Beach", "NuclearBunker", "AquaEvent"},
    Callback = function(value)
      selectedZone = value
    end
  })
  AWSTeleport:AddButton({
    ...
    Callback = function()
      if selectedZone then
        ...
        elseif selectedZone == "AquaEvent" then
          teleport("AquaEvent", "Aqua")
        end
      end
    end
  })
