-- ⚙️ Required ⚙️ --
pcall(function()
  loadstring(game:HttpGet('https://github.com/ZenithDust/Quantumix/raw/main/Functions/Executed.lua'))()
end)
...
local KeySystem = KeyLibrary.new('Quantumix')
...
local saved = isfile('quantumixkey.txt')

KeyButton.MouseButton1Click:Connect(function()
  if TextBox.Text then
    if KeySystem:verifyKey(TextBox.Text) then
      _G.finishKey = true
      if saved then
        appendfile('quantumixkey.txt', TextBox.Text)
      else
        writefile('quantumixkey.txt', TextBox.Text)
      end
      Notification.new('success', 'Quantumix', 'Correct Key', true, 3)
      print('Valid Key')
      wait(2)
      pcall(function()
      ...
      ScreenGui:Destroy()
      if KeyPremium and Key:verifyHWID() then
        _G.finishKey = true
        if saved then
          appendfile('quantumixkey.txt', TextBox.Text)
        else
        ...
        Notification.new('success', 'Quantumix', 'Correct Premium Key', true, 3)
        print('Valid Key')
        wait(1)
        pcall(function()
          loadstring(game:HttpGet(loadScript))()
      ...
      print('Invalid Key')
      Notification.new('error', 'Quantumix', 'Invalid Key')
    end
  end
end)
...
Discord.MouseButton1Click:Connect(function()
  Notification.new('success', 'Quantumix', "URL Copied!", true, 2)
...
GetKey.MouseButton1Click:Connect(function()
  local getkeyText = KeySystem:getKeyURL()
  Notification.new('success', 'Quantumix', 'URL Copied!', true, 3)
...
if saved then
  Notification.new('info', 'Quantumix', 'Key Loading...', true, 3)
  local savedKey = readfile('quantumixkey.txt')
    
  if KeySystem:verifyKey(savedKey) then
    _G.finishKey = true
    Notification.new('success', 'Quantumix', 'Key Loaded!', true, 3)
    print('Valid Key!')
    wait(1.5)
    pcall(function()
      loadstring(game:HttpGet(loadScript))()
    ...
    if KeyPremium and Key:verifyHWID() then
      _G.finishKey = true
      Notification.new('success', 'Quantumix', 'Loaded Premium Key!', true, 3)
      print('Valid Key!')
      wait(1.5)
      pcall(function()
        loadstring(game:HttpGet(loadScript))()
    ...
    Notification.new('error', 'Quantumix', 'No Saved Key!')
  end
end